...
class Application
{
    ...
    public function save_customer_info($data)
    {
        ...
        if (mysqli_query($this->db_connect, $sql)) {
            ...
            // echo $en_customer_id;
            // exit;
            $message = "<span>Dear $data[first_name]. Thanks for join our community</span>.</br>
              <span> Your Login Information goes here.</span> </br>
               <span> Email Address </span> : $data[email] </br>
               <span> Password </h3>:  $data[password] </span></br>
               <span>To activate your account click on bellow</span>.</br>
       
                <a href='http://localhost/eshopper/update_customer_status.php?id=$en_customer_id'>http://localhost/eshopper/update_customer_status.php?id=$en_customer_id</a> 
         ";
            $headers = "From: rony@gmail.com";
    ...
    {
        $sql = "UPDATE tbl_customer SET activation_status =1
